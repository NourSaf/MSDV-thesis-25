...
export default {
  ...
  methods: {
    ...
    renderMap() {
      ...
      d3.select('#map-2021-container').selectAll('*').remove();
      ...
      const svg = d3.select('#map-2021-container')
        .append('svg')
        .attr('width', width)
        .attr('height', height)
        ...
        svg.selectAll('.district')
          ...
          .on('mouseover', (event, d) => {
            ...
            tooltip.html(`
              ...
              <strong>Winner:</strong> ${d.properties['21_winners_Winner'] || 'N/A'}<br>
              <strong>Percent:</strong> ${d.properties['21_winners_Percent'] || 'N/A'}%
            `)
